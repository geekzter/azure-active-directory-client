...
output application_portal_url {
  ...
  value       = "https://portal.azure.com/#view/Microsoft_AAD_IAM/ManagedAppMenuBlade/~/Overview/objectId/${azuread_service_principal.enterprise_application.id}/appId/${azuread_application.app_registration.application_id}/preferredSingleSignOnMode~/null"
}
